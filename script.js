...
function eventChangingColorsPalette() {
  var getClassSelected = document.getElementsByClassName('selected')[0];
  var colorBlack = document.getElementsByClassName('color')[0];
  var colorRed = document.getElementsByClassName('color')[1];
  var colorBlue = document.getElementsByClassName('color')[2];
  var colorGreen = document.getElementsByClassName('color')[3];

  colorBlack.addEventListener('click', function script () {
    getClassSelected = document.getElementsByClassName('selected')[0];
    getClassSelected.classList.remove('selected');
    colorBlack.classList.add('selected');
    });

  colorRed.addEventListener('click', function script () {
    getClassSelected = document.getElementsByClassName('selected')[0];
    getClassSelected.classList.remove('selected');
    colorRed.classList.add('selected');
    });

  colorBlue.addEventListener('click', function script () {
    getClassSelected = document.getElementsByClassName('selected')[0];
    getClassSelected.classList.remove('selected');
    colorBlue.classList.add('selected');
    });
  colorGreen.addEventListener('click', function script () {
    getClassSelected = document.getElementsByClassName('selected')[0];
    getClassSelected.classList.remove('selected');
